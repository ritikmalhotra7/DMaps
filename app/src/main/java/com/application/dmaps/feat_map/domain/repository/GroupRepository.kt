...
interface GroupRepository {
    suspend fun createGroup():ResultState<Unit?,ResultError>
    suspend fun joinGroup(groupCode:String):ResultState<Unit?,ResultError>
    suspend fun updateDestination(groupId:String, destination:Location):ResultState<Unit?,ResultError>
    suspend fun removeUser(groupId:String, username:String):ResultState<Unit?, ResultError>
